yyy## Part 1 - Creating a Certificate 
...
```
      ...
      -  Add domain names          : "[your donamin name].net" (www.olmayacak naked domain name) and click next
...
Step-2 - Geo Restriction
 ...
 - Countries : slecet your country >>> Add
