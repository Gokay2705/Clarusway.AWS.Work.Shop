...
- Go to the Subnets from left hand menu
  ...
  - Select 'clarus-az1a-public-subnet' subnet ---> Action ---> Modify auto-assign 
...
- One is in the Private and the other one is in Public subnet. Show the public and private IPs of instances.
- 