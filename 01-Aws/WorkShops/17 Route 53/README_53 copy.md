...
Value/Route traffic to: 
  - select "IP address or another value depending the record type" option 
      - enter Public IP of the "N.Virginia_1" EC2
Record Type : A
Type: "A – IPv4 address"
Alias:"No"
TTL:"1m"
...
# STEP 1 : Create health check for "N. virgnia_1" instance [Heathcheck ucretli]
...
Health check            : firsthealthcheck [daha once olusturdugumuz healthchek eger healthcheck olusturulmazsa burada gorunmez.]
