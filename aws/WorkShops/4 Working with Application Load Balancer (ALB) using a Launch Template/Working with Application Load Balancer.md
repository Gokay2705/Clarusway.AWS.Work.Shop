...
# Network & Security/Security Groups altindan shh ve http anywhre secilecek.

- create a target group.
# Load Balancing/Target Groups altindan 
...
# Instance/Launch Templates altinda network setting virtual privite cloud, Instance type t2.micro
```text
...
<body>
    ...
    <p><img src="ryu.jpg" <b> alt="Oz Hakiki Cikolata Deryasi"</b></p>
</body>
